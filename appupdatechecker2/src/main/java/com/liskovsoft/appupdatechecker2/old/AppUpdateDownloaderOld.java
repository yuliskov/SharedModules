 ...
 * </pre>
 */
public class AppUpdateDownloaderOld extends AsyncTask<Uri[],Void,Void> {
    private static final String TAG = AppUpdateDownloaderOld.class.getSimpleName();
    private final Context mContext;
    private boolean mInProgress;
    private boolean mCancelInstall;
    private String mDownPath;

    public AppUpdateDownloaderOld(Context context) {
        mContext = context;
    }
