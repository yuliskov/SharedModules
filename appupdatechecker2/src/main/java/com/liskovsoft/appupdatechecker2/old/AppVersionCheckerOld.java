 ...
 */
public class AppVersionCheckerOld {
    private final static String TAG = AppVersionCheckerOld.class.getSimpleName();
    ...
    private final AppVersionCheckerOldListener mUpdateListener;
    private SharedPreferences mPrefs;

    private static final int MILLISECONDS_IN_MINUTE = 60000;
    private boolean mInProgress;
    
    public AppVersionCheckerOld(Context context, AppVersionCheckerOldListener updateListener) {
        mContext = context;
